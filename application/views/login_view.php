...
<html lang="en">
  <head>
    ...
    <!-- Animate.css -->
    <link href="<?=base_url();?>assets/theme/documentation/css/animate.min.css" rel="stylesheet">
        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form>
              ...
              <div>
                <a href="<?=site_url();?>/login_ctrl/verify_login" class="btn btn-success btn-lg submit">Login</a>
              </div>
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa"></i> HITACHI SERVICE CENTER</h1>
                  <p>©2016 All Rights Reserved.<br/>HITACHI SALES (THAILAND),LTD.</p>
                </div>
              </div>
            </form>
          </section>
