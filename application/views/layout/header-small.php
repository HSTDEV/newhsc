            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu" style="height:90%;">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="<?=site_url();?>/main_ctrl/dashboard"><i class="fa fa-home" style="color:#00BCD4"></i> Home</a></li>
                  <li><a><i class="fa fa-phone-square" style="color:#00BCD4"></i> รายการแจ้งซ่อม (HST) <span class="fa fa-chevron-down" style="color:#00BCD4"></span></a>
                  ...
                  <li><a><i class="fa fa-phone-square" style="color:#00BCD4"></i> รายการแจ้งซ่อม (SV) <span class="fa fa-chevron-down" style="color:#00BCD4"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li><a><i class="fa fa-phone-square" style="color:#00BCD4"></i> รายการแจ้งซ่อม (Technician) <span class="fa fa-chevron-down" style="color:#00BCD4"></span></a>
                    <ul class="nav child_menu">
                      <li><a  style="color:#FFEB3B" href="<?=site_url();?>/se_ctrl/">*รับเรื่องแจ้งซ่อม</a></li>
                      <li><a  style="color:#FFEB3B" href="<?=site_url();?>/se_ctrl/">*แก้ไขรายการแจ้งซ่อม</a></li>
                      <li><a  style="color:#FFEB3B" href="<?=site_url();?>/se_ctrl/">*รายการแจ้งซ่อม</a></li>
                  ...
                  <li><a><i class="fa fa-cubes" style="color:#00BCD4"></i> รายการสั่งซื้ออะไหล่ (HST) <span class="fa fa-chevron-down" style="color:#00BCD4"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?=site_url();?>/se_ctrl/">ซื้ออะไหล่</a></li>
                      <li><a href="<?=site_url();?>/se_ctrl/">รายการสั่งซื้ออะไหล่</a></li>
                      <li><a href="<?=site_url();?>/se_ctrl/">รายการเคลมอะไหล่</a></li>
                      <li><a href="<?=site_url();?>/se_ctrl/">รายการจองอะไหล่คงค้าง</a></li>
                      <li><a href="<?=site_url();?>/se_ctrl/">รายการคืนอะไหล่</a></li>
                      <li><a href="<?=site_url();?>/se_ctrl/">บันทึกข้อมูลการขนส่ง</a></li>
                      <li><a href="<?=site_url();?>/se_ctrl/">พิมพ์ใบรับฝากรวม</a></li>
                      <li><a href="<?=site_url();?>/se_ctrl/">ค้นหาข้อมูลอะไหล่</a></li>
                  ...
                  <li><a><i class="fa fa-cubes" style="color:#00BCD4"></i> รายการสั่งซื้ออะไหล่ (SV) <span class="fa fa-chevron-down" style="color:#00BCD4"></span></a>
                    <ul class="nav child_menu">
                      <li><a  style="color:#FFEB3B" href="<?=site_url();?>/se_ctrl/">*ซื้ออะไหล่</a></li>
                  ...
                  <li><a><i class="fa fa-cubes" style="color:#00BCD4"></i> รายการสั่งซื้ออะไหล่ (Technician) <span class="fa fa-chevron-down" style="color:#00BCD4"></span></a>
                    <ul class="nav child_menu">
                      <li><a  style="color:#FFEB3B" href="<?=site_url();?>/se_ctrl/">*เช็ครายการอะไหล่</a></li>
                  ...
                  <li><a><i class="fa fa-exchange" style="color:#00BCD4"></i> Cargo Return (HST) <span class="fa fa-chevron-down" style="color:#00BCD4"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li><a><i class="fa fa-exchange" style="color:#00BCD4"></i> Cargo Return (SV) <span class="fa fa-chevron-down" style="color:#00BCD4"></span></a>
                    <ul class="nav child_menu">
                      <li><a  style="color:#FFEB3B" href="<?=site_url();?>/se_ctrl/">*รายการคัดสินค้าคืน</a></li>
                      <li><a  style="color:#FFEB3B" href="<?=site_url();?>/se_ctrl/">*ค้นหาข้อมูลสินค้าคืน</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-exchange" style="color:#00BCD4"></i> Cargo Return Dealer <span class="fa fa-chevron-down" style="color:#00BCD4"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li><a><i class="fa fa-file" style="color:#00BCD4"></i> Report (HST) <span class="fa fa-chevron-down" style="color:#00BCD4"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li><a><i class="fa fa-file" style="color:#00BCD4"></i> Report (SV) <span class="fa fa-chevron-down" style="color:#00BCD4"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li><a><i class="fa fa-file" style="color:#00BCD4"></i> Report (Technician) <span class="fa fa-chevron-down" style="color:#00BCD4"></span></a>
                    <ul class="nav child_menu">
                      <li><a  style="color:#FFEB3B" href="<?=site_url();?>/se_ctrl/">*รายงานการแจ้งซ่อม (Repair Data Record)</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-list-alt" style="color:#00BCD4"></i> บัตรรับประกัน (Warranty Data Enquiry) <span class="fa fa-chevron-down" style="color:#00BCD4"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li><a><i class="fa fa-gears" style="color:#00BCD4"></i> Back Office <span class="fa fa-chevron-down" style="color:#00BCD4"></span></a>
                    <ul class="nav child_menu">
